package com.example.ddm.okthhp;

import android.content.Context;
import android.os.Handler;

import com.example.ddm.appui.utils.LogUtils;
import com.example.ddm.okthhp.body.ProgressRequestBody;
import com.example.ddm.okthhp.body.ResponseProgressBody;
import com.example.ddm.okthhp.response.DownloadResponseHandler;
import com.example.ddm.okthhp.response.GsonResponseHandler;
import com.example.ddm.okthhp.response.IResponseHandler;
import com.example.ddm.okthhp.response.JsonResponseHandler;
...
//                    Log.i("onResponse saveFile fail", String.valueOf(e));
//                    Log.e(, e + "","");
            ...
            if(response.isSuccessful()) {
                ...
                if(mResponseHandler instanceof JsonResponseHandler) {       //json回调
                    try {
                        ...
                        LogUtils.d("onResponse fail parse jsonobject, body=" + response_body);
                        mHandler.post(new Runnable() {
                            @Override
                            public void run() {
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                LogUtils.d("onResponse fail parse gson, body=" + response_body);
                ...
                LogUtils.d("onResponse fail status=" + response.code());
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {

 ...
 * 添加用户地址
 */
public class EditorAddressFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_editor_address, container, false);
    }
    ...
    protected void setListener() {
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addUserAddress(provinceId,cityId,townId, String.valueOf(check),mEditTextName.getText().toString(),mEditTextPhone.getText().toString(),mEditTextDetail.getText().toString());
            }
        });
    ...
    private void addUserAddress(String provinceId,String cityId,String townId,String ifDefault,String name,String phone,String detail){

 ...
 * 酒店
 */
public class HotelFragment extends BaseFragment implements PullToRefreshView.OnHeaderRefreshListener,PullToRefreshView.OnFooterRefreshListener{
        ...
        HttpHelper.getInstance().post(Url.GET_CATEGORY, param, new RawResponseHandler() {
            ...
            public void onSuccess(int statusCode, String response) {
                ...
                if (category.getCode()==1&&category.getDatas().size()>0) {
                    Id=category.getDatas().get(4).getID();

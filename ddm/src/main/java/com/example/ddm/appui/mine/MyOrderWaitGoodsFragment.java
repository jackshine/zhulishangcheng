 ...
 * 待发货
 */
public class MyOrderWaitGoodsFragment extends BaseFragment {
    ...
    public MyOrderWaitGoodsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_my_order_wait_goods, container, false);
    }
    ...
    private void requestOrderAllRefresh(final int page){
        ...
        HttpHelper.getInstance().post(Url.userPurchaseOrderList, param, new RawResponseHandler() {
            ...
            public void onSuccess(int statusCode, String response) {
                ...
                mLRecyclerView.refreshComplete(page);

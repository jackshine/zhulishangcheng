...
public class AppLoading {
    ...
    public AppLoading(BaseActivity activity) {
        initView(activity);
    }

    public AppLoading(BaseActivity activity, boolean outsideTouchCancelable) {
    ...
    protected void initView(BaseActivity activity) {
        ...
        mLoadingImg = (ImageView) mLoadingLayout.findViewById(R.id.loading_operate_img);
            mAnimation = AnimationUtils.loadAnimation(activity, R.anim.roatate_anim);
        setListener();
    }

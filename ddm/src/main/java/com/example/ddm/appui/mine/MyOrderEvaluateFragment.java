 ...
 * 待评价
 */
public class MyOrderEvaluateFragment extends BaseFragment {
    ...
    public MyOrderEvaluateFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_my_order_evaluate, container, false);
    }
    @Override

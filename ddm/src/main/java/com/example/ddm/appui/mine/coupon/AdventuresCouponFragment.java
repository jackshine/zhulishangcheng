 ...
 * 大转盘优惠券
 */
public class AdventuresCouponFragment extends BaseFragment {
    ...
    public AdventuresCouponFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_adventures_coupon, container, false);
    }
...
//                ImageView view = holder.getView(R.id.glide_icon);
                holder.getView(R.id.Relative).setBackgroundResource(R.drawable.award);
//                Glide.with(getContext()).load(Url.encode+item.getId()+".jpeg").placeholder(R.drawable.ic_launcher).crossFade().into(view);
                holder.setText(item.getStarTime()+"_"+item.getEndTime(),R.id.time1).
                        setText("抽奖卡",R.id.shop_name);
            }
            @Override
    ...
    protected void setListener() {
        ...
        mLRecyclerView.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                mAdapter.clear();
                SearchUserCoupon(mPage,2,mState,mOverdue);
            }
        });

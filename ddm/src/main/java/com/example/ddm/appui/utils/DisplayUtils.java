...
public class DisplayUtils {
    ...
    public static void init() {
        ...
        WindowManager wm = (WindowManager) PokonyanApplication.getInstance().getSystemService(Context.WINDOW_SERVICE);
        ...
        DisplayMetrics dm = PokonyanApplication.getInstance().getResources().getDisplayMetrics();
        mScale = dm.density;
        mDpi = dm.densityDpi;

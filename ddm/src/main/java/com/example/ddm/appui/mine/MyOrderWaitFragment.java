 ...
 * 待做单
 */
public class MyOrderWaitFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_my_order_wait, container, false);
    }
    @Override

 ...
 * 家装
 */
public class HomeDecorationFragment extends BaseFragment implements PullToRefreshView.OnHeaderRefreshListener,PullToRefreshView.OnFooterRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_home_decoration, container, false);
    }
        ...
        HttpHelper.getInstance().post(Url.GET_CATEGORY, param, new RawResponseHandler() {
            ...
            public void onSuccess(int statusCode, String response) {
                ...
                if (category.getCode()==1&&category.getDatas().size()>0) {
                    Id=category.getDatas().get(6).getID();

...
public class CommentAdapter extends CommonBaseAdapter<ShopDetail.DatasBean.CustomersdatasBean> {
    private FunnyGridAdapter funnyGridAdapter;
    private static final int TYPE_ONE=0;
    private static final  int TYPE_TWO=1;
    private List<String> mList = new ArrayList<>();
    private int type;
    public CommentAdapter(Context context, List<ShopDetail.DatasBean.CustomersdatasBean> dataList) {
...
//                   vh.tv_time= (TextView) convertView.findViewById(R.id.tv_funny_time);
        ...
        ShopDetail.DatasBean.CustomersdatasBean funnyBean = mDataList.get(position);

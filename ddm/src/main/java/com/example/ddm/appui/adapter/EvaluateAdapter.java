...
public class EvaluateAdapter extends CommonBaseAdapter<EvaluateBean.DatasBean> {
    private FunnyGridAdapter funnyGridAdapter;
    private static final int TYPE_ONE=0;
    private static final  int TYPE_TWO=1;
    private List<String> mList = new ArrayList<>();
    private int type;
    public EvaluateAdapter(Context context, List<EvaluateBean.DatasBean> dataList) {
...
//                   vh.tv_time= (TextView) convertView.findViewById(R.id.tv_funny_time);
        ...
        EvaluateBean.DatasBean funnyBean = mDataList.get(position);
        vh.mShopName.setText(funnyBean.getCustomerRealName());
